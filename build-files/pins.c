...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_RELAY_A),  MP_ROM_PTR(&pin_PA17)  },
    { MP_ROM_QSTR(MP_QSTR_RELAY_B),  MP_ROM_PTR(&pin_PB05)  },
    { MP_ROM_QSTR(MP_QSTR_BURN1),    MP_ROM_PTR(&pin_PB31)  },
    { MP_ROM_QSTR(MP_QSTR_BURN2),    MP_ROM_PTR(&pin_PA15)  },
    { MP_ROM_QSTR(MP_QSTR_BURN3),    MP_ROM_PTR(&pin_PB07)  },
    { MP_ROM_QSTR(MP_QSTR_BURN4),    MP_ROM_PTR(&pin_PB09)  },
    { MP_ROM_QSTR(MP_QSTR_BURN5),    MP_ROM_PTR(&pin_PB04)  },

    { MP_ROM_QSTR(MP_QSTR_BATTERY),  MP_ROM_PTR(&pin_PA06) },
    { MP_ROM_QSTR(MP_QSTR_L1PROG),   MP_ROM_PTR(&pin_PA07)  },
    { MP_ROM_QSTR(MP_QSTR_IBATT),    MP_ROM_PTR(&pin_PA04)  },
    ...
    { MP_ROM_QSTR(MP_QSTR_RF_RST),   MP_ROM_PTR(&pin_PB00)  },
    { MP_ROM_QSTR(MP_QSTR_RF_CS),    MP_ROM_PTR(&pin_PB30)  },
    { MP_ROM_QSTR(MP_QSTR_RF_IO0),   MP_ROM_PTR(&pin_PB05)  },
    { MP_ROM_QSTR(MP_QSTR_RF_IO1),   MP_ROM_PTR(&pin_PB06)  },
